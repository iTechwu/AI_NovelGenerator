...
export class EmailAuthService extends TransactionalServiceBase {
  ...
  @HandlePrismaError(DbOperationType.QUERY)
  async getByUserId(value: string, additional?: { select?: Prisma.EmailAuthSelect; include?: Prisma.EmailAuthInclude }): Promise<EmailAuth | null> {
    return this.getReadClient().emailAuth.findUnique({
      where: { userId: value },
      ...additional,
    });
  ...
  @HandlePrismaError(DbOperationType.CREATE)
  async createMany(
    data: Prisma.EmailAuthCreateManyInput[],
