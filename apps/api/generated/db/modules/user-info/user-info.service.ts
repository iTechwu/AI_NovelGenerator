...
export class UserInfoService extends TransactionalServiceBase {
  ...
  @HandlePrismaError(DbOperationType.QUERY)
  async getBySsoSub(value: string, additional?: { select?: Prisma.UserInfoSelect }): Promise<UserInfo | null> {
    return this.getReadClient().userInfo.findUnique({
  ...
  @HandlePrismaError(DbOperationType.QUERY)
  async getByCode(value: string, additional?: { select?: Prisma.UserInfoSelect }): Promise<UserInfo | null> {
    return this.getReadClient().userInfo.findUnique({
  ...
  @HandlePrismaError(DbOperationType.UPDATE)
  async upsert(
    args: Prisma.UserInfoUpsertArgs,
  ): Promise<UserInfo> {
