 ...
 *
 * StorageAdapter: Uses scaffold.dofe.ai storage (localStorage + cookie)
...
/**
 * scaffold.dofe.ai storage adapter.
 * Stores access token in cookie for middleware + localStorage for client.
 */
const scaffoldStorageAdapter: StorageAdapter = {
...
/**
 * scaffold.dofe.ai API client adapter.
...
const tokenManager = createTokenManager(scaffoldStorageAdapter, scaffoldRefreshClient);
