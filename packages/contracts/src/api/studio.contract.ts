...
import {
  ...
  StudioStandaloneScreenplaySceneListResponseSchema,
  CreateStudioStandaloneScreenplayRevisionSchema,
  StudioStandaloneScreenplayRevisionSchema,
  StudioStandaloneScreenplayRevisionListQuerySchema,
  StudioStandaloneScreenplayRevisionListResponseSchema,
  StudioStandaloneScreenplayExportQuerySchema,
  StudioStandaloneScreenplayExportSchema,
...
export const studioContract = c.router(
  {
    ...
    startReviewReady: {
      method: 'POST',
      path: '/adaptations/:adaptationId/review-ready/start',
      pathParams: z.object({ adaptationId: z.string().uuid() }),
      body: z.object({}),
      responses: { 200: ApiResponseSchema(StudioAdaptationProjectSchema) },
      summary:
        'Advance an adaptation from script writing to comparative review once at least one screenplay revision exists',
    },
    startDeliverable: {
      method: 'POST',
      path: '/adaptations/:adaptationId/deliverable/start',
      pathParams: z.object({ adaptationId: z.string().uuid() }),
      body: z.object({}),
      responses: { 200: ApiResponseSchema(StudioAdaptationProjectSchema) },
      summary: 'Advance a reviewed adaptation to deliverable',
    },
    saveScenePlan: {
      method: 'PUT',
    ...
    listAdaptationSourceDrift: {
      method: 'GET',
      path: '/adaptations/:adaptationId/source-drift',
      pathParams: z.object({ adaptationId: z.string().uuid() }),
      responses: { 200: ApiResponseSchema(StudioAdaptationSourceDriftSchema) },
      summary:
        'Detect source chapters finalized after the immutable adaptation snapshot (re-review signal)',
    },
    markSourceSceneMappingsStale: {
      method: 'POST',
      path: '/adaptations/:adaptationId/source-mappings/stale',
      pathParams: z.object({ adaptationId: z.string().uuid() }),
      body: z.object({}),
    ...
    listStandaloneScreenplayScenes: {
      method: 'GET',
      path: '/projects/:projectId/screenplay/scenes',
      pathParams: z.object({ projectId: z.string().uuid() }),
      query: StudioStandaloneScreenplaySceneListQuerySchema,
      responses: { 200: ApiResponseSchema(StudioStandaloneScreenplaySceneListResponseSchema) },
      summary: 'List editable scene plans for an independent screenplay project',
    },
    saveStandaloneScreenplayScene: {
      method: 'PUT',
      path: '/projects/:projectId/screenplay/scenes',
      pathParams: z.object({ projectId: z.string().uuid() }),
      body: SaveStudioStandaloneScreenplaySceneSchema,
      responses: { 200: ApiResponseSchema(StudioStandaloneScreenplaySceneSchema) },
      summary: 'Create or update an independent screenplay scene plan',
    },
    listStandaloneScreenplayRevisions: {
      method: 'GET',
      path: '/projects/:projectId/screenplay/scenes/:sceneId/revisions',
      pathParams: z.object({ projectId: z.string().uuid(), sceneId: z.string().uuid() }),
      query: StudioStandaloneScreenplayRevisionListQuerySchema,
      responses: { 200: ApiResponseSchema(StudioStandaloneScreenplayRevisionListResponseSchema) },
      summary: 'List immutable Fountain revisions for an independent screenplay scene',
    },
    createStandaloneScreenplayRevision: {
      method: 'POST',
      path: '/projects/:projectId/screenplay/scenes/:sceneId/revisions',
      pathParams: z.object({ projectId: z.string().uuid(), sceneId: z.string().uuid() }),
      body: CreateStudioStandaloneScreenplayRevisionSchema,
      responses: { 201: ApiResponseSchema(StudioStandaloneScreenplayRevisionSchema) },
      summary: 'Append an immutable Fountain revision to an independent screenplay scene',
    },
    exportStandaloneScreenplay: {
      method: 'GET',
      path: '/projects/:projectId/screenplay/export',
      pathParams: z.object({ projectId: z.string().uuid() }),
      query: StudioStandaloneScreenplayExportQuerySchema,
      responses: { 200: ApiResponseSchema(StudioStandaloneScreenplayExportSchema) },
      summary: 'Export the latest revision of each independent screenplay scene',
    },
    exportProject: {
      method: 'GET',
